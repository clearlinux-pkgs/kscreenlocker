...
Source0  : https://download.kde.org/stable/plasma/5.27.4/kscreenlocker-5.27.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/kscreenlocker-5.27.4.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-5.27.4
cd %{_builddir}/kscreenlocker-5.27.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680720992
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.27.4
