...
Version  : 5.15.2
Release  : 17
URL      : https://github.com/KDE/kscreenlocker/archive/v5.15.2.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.15.2.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.15.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1551200917
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKScreenLocker.so.5.15.2
