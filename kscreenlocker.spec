...
Version  : 5.17.4
Release  : 31
URL      : https://github.com/KDE/kscreenlocker/archive/v5.17.4/kscreenlocker-5.17.4.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.17.4/kscreenlocker-5.17.4.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.17.4
cd %{_builddir}/kscreenlocker-5.17.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576518448
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreenlocker-5.17.4/COPYING %{buildroot}/usr/share/package-licenses/kscreenlocker/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKScreenLocker.so.5.17.4
