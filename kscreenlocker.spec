...
Source0  : https://download.kde.org/stable/plasma/6.1.0/kscreenlocker-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/kscreenlocker-6.1.0.tar.xz.sig
...
%setup -q -n kscreenlocker-6.1.0
cd %{_builddir}/kscreenlocker-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718893500
mkdir -p clr-build
pushd clr-build
