...
Version  : 5.26.3
Release  : 76
URL      : https://download.kde.org/stable/plasma/5.26.3/kscreenlocker-5.26.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.3/kscreenlocker-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/kscreenlocker-5.26.3.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-5.26.3
cd %{_builddir}/kscreenlocker-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667919591
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.26.3
