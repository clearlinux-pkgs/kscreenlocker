...
Source0  : https://download.kde.org/stable/plasma/6.0.3/kscreenlocker-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/kscreenlocker-6.0.3.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-6.0.3
cd %{_builddir}/kscreenlocker-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711666508
mkdir -p clr-build
pushd clr-build
