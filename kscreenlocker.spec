...
Version  : 6.0.5
Release  : 99
URL      : https://download.kde.org/stable/plasma/6.0.5/kscreenlocker-6.0.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.5/kscreenlocker-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/kscreenlocker-6.0.5.tar.xz.sig
...
%setup -q -n kscreenlocker-6.0.5
cd %{_builddir}/kscreenlocker-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716478724
mkdir -p clr-build
pushd clr-build
