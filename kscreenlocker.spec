...
Version  : 6.0.4
Release  : 98
URL      : https://download.kde.org/stable/plasma/6.0.4/kscreenlocker-6.0.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.4/kscreenlocker-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/kscreenlocker-6.0.4.tar.xz.sig
...
%setup -q -n kscreenlocker-6.0.4
cd %{_builddir}/kscreenlocker-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713319359
mkdir -p clr-build
pushd clr-build
