...
Version  : 5.17.3
Release  : 30
URL      : https://github.com/KDE/kscreenlocker/archive/v5.17.3/kscreenlocker-5.17.3.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.17.3/kscreenlocker-5.17.3.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.17.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573570096
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreenlocker-5.17.3/COPYING %{buildroot}/usr/share/package-licenses/kscreenlocker/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKScreenLocker.so.5.17.3
