...
Version  : 5.15.3
Release  : 18
URL      : https://github.com/KDE/kscreenlocker/archive/v5.15.3.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.15.3.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.15.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1552412090
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.15.3
