...
Version  : 5.16.0
Release  : 21
URL      : https://github.com/KDE/kscreenlocker/archive/v5.16.0/kscreenlocker-5.16.0.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.16.0/kscreenlocker-5.16.0.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.16.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1560268305
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKScreenLocker.so.5.16.0
