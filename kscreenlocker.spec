...
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.15.0.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.15.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1549994106
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKScreenLocker.so.5.15.0
