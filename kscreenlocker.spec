...
Version  : 6.1.5
Release  : 108
URL      : https://download.kde.org/stable/plasma/6.1.5/kscreenlocker-6.1.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.5/kscreenlocker-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/kscreenlocker-6.1.5.tar.xz.sig
...
%setup -q -n kscreenlocker-6.1.5
cd %{_builddir}/kscreenlocker-6.1.5
pushd ..
cp -a kscreenlocker-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725985617
mkdir -p clr-build
pushd clr-build
