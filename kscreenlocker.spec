...
Version  : 5.16.3
Release  : 24
URL      : https://github.com/KDE/kscreenlocker/archive/v5.16.3/kscreenlocker-5.16.3.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.16.3/kscreenlocker-5.16.3.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.16.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562726853
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.16.3
