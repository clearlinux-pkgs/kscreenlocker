...
Source0  : https://download.kde.org/stable/plasma/6.3.0/kscreenlocker-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/kscreenlocker-6.3.0.tar.xz.sig
...
%setup -q -n kscreenlocker-6.3.0
cd %{_builddir}/kscreenlocker-6.3.0
pushd ..
cp -a kscreenlocker-6.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739291492
mkdir -p clr-build
pushd clr-build
