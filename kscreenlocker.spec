...
Version  : 5.16.1
Release  : 22
URL      : https://github.com/KDE/kscreenlocker/archive/v5.16.1/kscreenlocker-5.16.1.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.16.1/kscreenlocker-5.16.1.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.16.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1560870582
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.16.1
