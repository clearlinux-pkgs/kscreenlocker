...
Version  : 5.15.1
Release  : 16
URL      : https://github.com/KDE/kscreenlocker/archive/v5.15.1.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.15.1.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.15.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1550599250
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKScreenLocker.so.5.15.1
