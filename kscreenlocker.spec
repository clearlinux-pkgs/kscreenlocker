...
Version  : 5.15.5
Release  : 20
URL      : https://github.com/KDE/kscreenlocker/archive/v5.15.5/kscreenlocker-5.15.5.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.15.5/kscreenlocker-5.15.5.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.15.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1557241241
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKScreenLocker.so.5.15.5
