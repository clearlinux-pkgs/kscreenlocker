...
Source0  : https://download.kde.org/stable/plasma/6.3.1/kscreenlocker-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/kscreenlocker-6.3.1.tar.xz.sig
...
%setup -q -n kscreenlocker-6.3.1
cd %{_builddir}/kscreenlocker-6.3.1
pushd ..
cp -a kscreenlocker-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739898199
mkdir -p clr-build
pushd clr-build
