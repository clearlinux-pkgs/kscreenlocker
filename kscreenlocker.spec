...
Version  : 5.19.1
Release  : 40
URL      : https://github.com/KDE/kscreenlocker/archive/v5.19.1/kscreenlocker-5.19.1.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.19.1/kscreenlocker-5.19.1.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.19.1
cd %{_builddir}/kscreenlocker-5.19.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592340791
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreenlocker-5.19.1/COPYING %{buildroot}/usr/share/package-licenses/kscreenlocker/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKScreenLocker.so.5.19.1
