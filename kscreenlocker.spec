...
Version  : 5.23.5
Release  : 60
URL      : https://download.kde.org/stable/plasma/5.23.5/kscreenlocker-5.23.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.5/kscreenlocker-5.23.5.tar.xz
...
%prep
%setup -q -n kscreenlocker-5.23.5
cd %{_builddir}/kscreenlocker-5.23.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641314736
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreenlocker-5.23.5/COPYING %{buildroot}/usr/share/package-licenses/kscreenlocker/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKScreenLocker.so.5.23.5
