...
Source0  : https://download.kde.org/stable/plasma/5.27.9/kscreenlocker-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/kscreenlocker-5.27.9.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-5.27.9
cd %{_builddir}/kscreenlocker-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698279411
mkdir -p clr-build
pushd clr-build
