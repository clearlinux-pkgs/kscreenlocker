...
Version  : 5.13.3
Release  : 1
URL      : https://github.com/KDE/kscreenlocker/archive/v5.13.3.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.13.3.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.13.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1532453887
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libKScreenLocker.so.5.13.3
