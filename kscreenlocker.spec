...
Version  : 5.14.2
Release  : 8
URL      : https://github.com/KDE/kscreenlocker/archive/v5.14.2.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.14.2.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.14.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1540462260
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKScreenLocker.so.5.14.2
