...
Source0  : https://download.kde.org/stable/plasma/5.26.2/kscreenlocker-5.26.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.2/kscreenlocker-5.26.2.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-5.26.2
cd %{_builddir}/kscreenlocker-5.26.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667239063
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.26.2
