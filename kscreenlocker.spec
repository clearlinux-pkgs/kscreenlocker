...
Version  : 6.1.1
Release  : 102
URL      : https://download.kde.org/stable/plasma/6.1.1/kscreenlocker-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/kscreenlocker-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/kscreenlocker-6.1.1.tar.xz.sig
...
%setup -q -n kscreenlocker-6.1.1
cd %{_builddir}/kscreenlocker-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719415485
mkdir -p clr-build
pushd clr-build
