...
Source0  : https://download.kde.org/stable/plasma/6.1.2/kscreenlocker-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/kscreenlocker-6.1.2.tar.xz.sig
...
%setup -q -n kscreenlocker-6.1.2
cd %{_builddir}/kscreenlocker-6.1.2
pushd ..
cp -a kscreenlocker-6.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720571911
mkdir -p clr-build
pushd clr-build
