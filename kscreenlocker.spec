...
Version  : 5.14.4
Release  : 11
URL      : https://github.com/KDE/kscreenlocker/archive/v5.14.4.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.14.4.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.14.4
...
export LANG=C
export SOURCE_DATE_EPOCH=1543374835
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKScreenLocker.so.5.14.4
