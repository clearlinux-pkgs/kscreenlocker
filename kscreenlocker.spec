...
Version  : 5.16.5
Release  : 26
URL      : https://github.com/KDE/kscreenlocker/archive/v5.16.5/kscreenlocker-5.16.5.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.16.5/kscreenlocker-5.16.5.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.16.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568382439
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKScreenLocker.so.5.16.5
