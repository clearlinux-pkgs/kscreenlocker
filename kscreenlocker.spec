...
Version  : 5.18.4.1
Release  : 37
URL      : https://github.com/KDE/kscreenlocker/archive/v5.18.4.1/kscreenlocker-5.18.4.1.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.18.4.1/kscreenlocker-5.18.4.1.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.18.4.1
cd %{_builddir}/kscreenlocker-5.18.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585677467
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreenlocker-5.18.4.1/COPYING %{buildroot}/usr/share/package-licenses/kscreenlocker/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKScreenLocker.so.5.18.4
