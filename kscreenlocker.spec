...
Version  : 6.1.3
Release  : 104
URL      : https://download.kde.org/stable/plasma/6.1.3/kscreenlocker-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/kscreenlocker-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/kscreenlocker-6.1.3.tar.xz.sig
...
%setup -q -n kscreenlocker-6.1.3
cd %{_builddir}/kscreenlocker-6.1.3
pushd ..
cp -a kscreenlocker-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721142862
mkdir -p clr-build
pushd clr-build
