...
Version  : 5.27.6
Release  : 87
URL      : https://download.kde.org/stable/plasma/5.27.6/kscreenlocker-5.27.6.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.6/kscreenlocker-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/kscreenlocker-5.27.6.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-5.27.6
cd %{_builddir}/kscreenlocker-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687281738
mkdir -p clr-build
pushd clr-build
