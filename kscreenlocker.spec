...
Version  : 5.14.1
Release  : 7
URL      : https://github.com/KDE/kscreenlocker/archive/v5.14.1.tar.gz
Source0  : https://github.com/KDE/kscreenlocker/archive/v5.14.1.tar.gz
...
%prep
%setup -q -n kscreenlocker-5.14.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1539703148
mkdir -p clr-build
pushd clr-build
%cmake ..
...
/usr/lib64/libKScreenLocker.so.5.14.1
