...
Source0  : https://download.kde.org/stable/plasma/5.24.1/kscreenlocker-5.24.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.1/kscreenlocker-5.24.1.tar.xz.sig
...
%prep
%setup -q -n kscreenlocker-5.24.1
cd %{_builddir}/kscreenlocker-5.24.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645025759
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kscreenlocker-5.24.1/COPYING %{buildroot}/usr/share/package-licenses/kscreenlocker/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKScreenLocker.so.5.24.1
